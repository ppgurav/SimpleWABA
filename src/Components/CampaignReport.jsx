...
function CampaignReport() {
  ...
  return (
    <div className='w-full h-full overflow-y-auto bg-gray-50 p-10 mt-8'>
      <div className='w-full bg-white shadow-md rounded-lg p-6'>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            <button className="bg-gradient-to-br from-green-200 to-green-600 text-white px-10 py-4 rounded-lg transform hover:scale-105 transition duration-300">Export Delivered Messages</button>
            <button className="bg-gradient-to-br from-yellow-200 to-yellow-500 text-white px-10 py-4 rounded-lg transform hover:scale-105 transition duration-300">Export Read Messages</button>
            <button className="bg-gradient-to-br from-gray-200 to-gray-800 text-white px-10 py-4 rounded-lg transform hover:scale-105 transition duration-300">Download Complete Report</button>
            <button className="bg-gradient-to-br from-blue-200 to-blue-600 text-white px-10 py-4 rounded-lg transform hover:scale-105 transition duration-300">📩 Share Campaign Summary</button>
          </div>
