    ...
    <div className="flex min-h-screen">
              ...
              {["today", "yesterday", "this_week", "last_week", "month"].map((filter) => (
                <button
                  ...
                  className={`hover:text-blue-600 ${
                    timeFilter === filter ? "text-blue-600 font-bold" : ""
                  }`}
                >
                  {filter.replace("_", " ").replace(/\b\w/g, (c) => c.toUpperCase())}
                </button>
      ...
      <div className="w-[320px] bg-white shadow-md p-6 min-h-screen border-l mt-20 flex flex-col items-center rounded-2xl">
        ...
        <div className="flex justify-between items-center w-full mb-6 px-2">
         ...
         <img
          src="https://pps.whatsapp.net/v/t61.24694-24/427468236_498644819772812_8332225527870182080_n.jpg?ccb=11-4&oh=01_Q5Aa1wH1u7ImglHj_83UXlcauaij9brdl0ii_KxhQ-1hadrB7Q&oe=68640908&_nc_sid=5e03e0&_nc_cat=109"
          alt="Profile"
          className="w-24 h-24 rounded-full mb-4 object-cover shadow-md mt-3"
        />
        {/* Overview Items */}
        <div className="space-y-4 w-full">
          <div className="bg-gray-50 p-5 rounded-lg shadow-lg mt-5 ">Technfest</div>
          ...
          <div className="bg-gray-50 p-5 rounded-lg shadow-lg mt-5">Address: </div>
        </div>
      </div>
    </div>
  )
