...
<div className="flex flex-wrap justify-between gap-1 bg-gray-200 p-1 rounded-lg">
  ...
  rows="8"
  placeholder="Type your message here...">{`<p>Hello {first_name} {last_name},</p><p>We received a request to reset your password for your {site_name} account.</p><p>If you made this request, click the button below to reset your password:</p><p><a href="{reset_link}">Reset Password</a></p><p>If you did not request a password reset, please ignore this email or contact support at <a href="mailto:{company_email}">{company_email}</a>.</p>`}</textarea>
