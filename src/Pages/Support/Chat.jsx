...
//             <div className="relative w-4 h-4 ml-auto">
//               <span className="text-xs text-gray-500">{timestamp}</span>
//               <CheckCheck size={12} className="absolute left-1 top-0 text-gray-400" />
//             </div>
//           </div>
//         )
//       case MessageStatus.READ:
  ...
  const handleFileSend = async (e, type) => {
    ...
    try {
      ...
      const messageBody = {
        ...
        [type]: {
          link: uploadedUrl,
          caption: type === "image" ? "Here is the image" : undefined,
...
{messages.map((msg) => (
  <div key={msg.timestamp}>
    {msg.type === "image" && (
      <img src={msg.mediaUrl} alt="sent image" className="w-40 rounded" />
    )}
    {msg.type === "video" && (
      <video src={msg.mediaUrl} controls className="w-40 rounded" />
    )}
    {msg.type === "document" && (
